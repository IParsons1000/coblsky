...
INIT-TLS.
	*> create ssl context
	...
	IF NETWORK-SSL-CONTEXT EQUAL 0 THEN
...
PROCEDURE DIVISION USING NETWORK-SOCKET.
    ...
    *> configure socket
	IF SIN-PORT EQUAL 0 THEN
	    IF SOCK-SECURED EQUAL 1 THEN
