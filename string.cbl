...
PROCEDURE DIVISION USING STR-STRING, C, I.
    ...
    PERFORM VARYING I FROM 1 BY 1 UNTIL (I IS GREATER THAN STR-LEN) OR (STR-DAT(I:1) EQUAL C)
	    CONTINUE
	END-PERFORM.
...
PROCEDURE DIVISION USING SRC-STRING, DST-STRING, I.
    ...
    PERFORM VARYING I FROM 1 BY 1 UNTIL (I IS GREATER THAN (SRC-LEN - DST-LEN + 1)) OR (SRC-DAT(I:DST-LEN) EQUAL DST-DAT(1:DST-LEN))
	    CONTINUE
	END-PERFORM.
