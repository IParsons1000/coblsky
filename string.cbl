...
PROCEDURE DIVISION USING SRC-STRING, DST-STRING, I.
    ...
    PERFORM VARYING I FROM 1 BY 1 UNTIL (I IS GREATER THAN (SRC-LEN - DST-LEN)) OR (SRC-DAT(I:DST-LEN) EQUALS DST-DAT(1:DST-LEN))
	    CONTINUE
	END-PERFORM.

    IF I IS GREATER THAN (SRC-LEN - DST-LEN) THEN
	    MOVE -1 TO I
	ELSE
	    ADD DST-LEN TO I
